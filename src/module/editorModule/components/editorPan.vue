        ...
        <div class="page-preview-wrapper"
          ...
          <div class="editor-wrapper"
            ...
            <div class="editor-wrapper-container" v-if="projectData.elements.length">
				<draggable v-model="projectData.elements" group="site" :animation="340" @start="onStart" @end="onEnd">
				  <pl-container
...
<script>
  ...
  @Component({components: {plContainer, childNodeComponent, toolBtn, draggable}, methods: {getCommonStyle}})
  // editor画板入口
